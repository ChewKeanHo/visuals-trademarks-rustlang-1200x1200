# Rust Programming Language (Rust) Trademarks Logo 1200x1200 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/Pictures/banner_1200x1200.svg)](#)

The Rust Trademarks Logo. They published clear trademark guideline and supplied
the required material files for it. The preferred version is `.svg` which has
...
This project re-draws Rust Trademarks Logo specifically for 1200x1200 size.
...
```
--------------------------------------------------------------------------------
Title: Rust Programming Language (Rust) Trademarks Logo 1200x1200
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-trademarks-rustlang-1200x1200
UUID: 5DA1AA60-7F97-4DF2-B027-A9750A864ECA
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2026-02-21
Made From: Malaysia, South East Asia
Procure: https://github.com/chewkeanho/visuals-trademarks-rustlang-1200x1200
--------------------------------------------------------------------------------
```
